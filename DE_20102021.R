...
DE_data <- prot_data %>% select(accession, B12_4_1_A, B12_4_2_B, B12_4_3_B, noB12_4_1_A, noB12_4_2_B, B12_12_1_B, B12_12_3_A, noB12_12_2_B, noB12_12_3_A)
...
write.csv(hits_12_B12, file = 'hits_12_B12_20102021.csv')
write.csv(hits_4_noB12, file = 'hits_4_noB12_20102021.csv')
write.csv(hits_12_noB12  , file = 'hits_12_noB12_20102021.csv')
