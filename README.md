...
This repo contains code for conducting a differential expression analysis of proteins from _F. cylindrus_ cultures grown under high temperature treatments and vitamin B<sub>12</sub> starvation. Thanks to the brilliant [Scott McCain](https://jspmccain.github.io/) for the code from [Wu et al. 2019](https://doi.org/10.1038/s41467-019-11426-z) that this tutorial is based on, which can be found [here](https://github.com/jspmccain). 
